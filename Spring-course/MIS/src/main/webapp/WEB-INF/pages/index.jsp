                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element mylogo">
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                <li><a class="J_menuItem" href="${pageContext.request.contextPath}/main/update-logo">修改头像</a>
                                </li>
                                
                                <li><a class="J_menuItem" href="${pageContext.request.contextPath}/main/update-password">修改密码</a>
                                <li class="divider"></li>
                                <li><a href="${pageContext.request.contextPath}/main/login.jsp">安全退出</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="${pageContext.request.contextPath}/main/list-employee" data-index="0">人员管理</a>
                            </li>
